...
LAPIS_LAZULI_ORE    = BlockType.LapislazuliOre
LAPIS_LAZULI_BLOCK  = BlockType.LapisBlock
SANDSTONE           = BlockType.Sandstone
BED                 = BlockType.BedBlock
COBWEB              = BlockType.SpiderWeb
GRASS_TALL          = BlockType.TallGrass
WOOL                = BlockType.WoolWhite
...
STAIRS_WOOD         = BlockType.WoodenStair
...
STAIRS_COBBLESTONE  = BlockType.StoneBrickStair
